...
Revision ID: c748efa39ad8
Revises: 
Create Date: 2024-03-17 12:57:54.902306
...
def upgrade() -> None:
    ...
    sa.Column('vacancie_id', sa.Integer(), nullable=False),
    sa.Column('cover_letter', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['vacancie_id'], ['vacancies.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('resume_id', 'vacancie_id')
    )
